...
SECRET_KEY = configs['APP']['SECRET_KEY']
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'User.Serializer.PetCareUserSerializer',
}


AUTH_USER_MODEL = 'User.PetCareUser'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / configs['database']['name'],
    }
}
